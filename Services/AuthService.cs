...
namespace Backend.Services
{
    public class AuthService : IAuthService
	{
        ...
        public async Task<AuthServiceResponseDto> LoginAsync(LoginDto dto)
        {
        ...
        public async Task<AuthServiceResponseDto> MakeAdminAsync(UpdatePermissionDto dto)
        {
            var user = await _userManager.FindByNameAsync(dto.UserName);
        ...
        public async Task<AuthServiceResponseDto> RegisterAsync(RegisterDto dto)
        {
